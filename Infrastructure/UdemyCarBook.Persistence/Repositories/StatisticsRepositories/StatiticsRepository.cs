...
{
    public class StatiticsRepository : IStatisticsRepository
    {
        private readonly CarBookContext _context;

        public StatiticsRepository(CarBookContext context)
        {
            _context = context;
        }
        ...
        public string GetCarBrandAndModelByRentPriceDailyMax()
        {
            ...
            string brandModel = _context.Cars.Where(x => x.CarID == carId).Include(y => y.Brand).Select(z => z.Model).FirstOrDefault();
            return brandModel;
        }
        ...
        public string GetCarBrandAndModelByRentPriceDailyMin()
        {
            ...
            int carId = _context.CarPricings.Where(x => x.Amount == amount).Select(y => y.CarID).FirstOrDefault();
            string brandModel = _context.Cars.Where(x => x.CarID == carId).Include(y => y.Brand).Select(z => z.Brand.Name).FirstOrDefault();
            return brandModel;
        }
